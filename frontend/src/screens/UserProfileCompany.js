        ...
        <div className="panel__main__companies">
          <Col style={{ flex: "1" }}>
            ...
            <Row style={{ padding: "1em 0em" }}>
              <Nav
                variant="pills"
                defaultActiveKey="/dashboard/companies/details/applicant-details"
              >
                <Nav.Link
                  to="/dashboard/companies/details/applicant-details"
                  href="/dashboard/companies/details/applicant-details"
                  as={Link}
                ...
                <Nav.Link
                  to="/dashboard/companies/details/applicant-details/applied"
                  as={Link}
                  className="nav__link__horizontal"
                  eventKey="link-1"
                >
                ...
                <Nav.Link
                  to="/dashboard/companies/details/applicant-details/work-Experience"
                  as={Link}
                  className="nav__link__horizontal"
                  eventKey="link-2"
                >
                ...
                <Nav.Link
                  to="/dashboard/companies/details/applicant-details/project-portfolio"
                  as={Link}
                  className="nav__link__horizontal"
                  eventKey="link-3"
                >
                ...
                <Nav.Link
                  to="/dashboard/companies/details/applicant-details/education"
                  as={Link}
                  className="nav__link__horizontal"
                  eventKey="link-4"
                >
                ...
                <Nav.Link
                  to="/dashboard/companies/details/applicant-details/contact"
                  as={Link}
                  className="nav__link__horizontal"
                  eventKey="link-5"
                >
            ...
            <Row>
              <Switch>
                <Route
                  path="/dashboard/companies/details/applicant-details"
                  exact
                >
                  <Col>
                    <Row>
                              ...
                              <Col>
                                ...
                                <Row className="card-list-item">
                                  ...
                                  >
                                    <g
                                      id="pin"
                                      transform="translate(0.279 0.25)"
                                    >
                                      <path
                                        id="Path_280"
                                        data-name="Path 280"
                ...
                <Route path="/dashboard/companies/details/applicant-details/applied">
                ...
                <Route path="/dashboard/companies/details/applicant-details/work-Experience">
                  <Col style={{ padding: "0em" }}>
                    <Row>
                      ...
                      <Col>
                        ...
                        <Row className="user-profile-time-created">
                          1 yer 1 mo
                        </Row>
                        <Row className="user-profile-disignation">
                          Lorem ipsum
                        </Row>
                        <Row className="user-profile-date">2009-2010</Row>
                        <Row className="user-profile-content">
                          Lorem ipsum dolor sit, amet consectetur adipisicing
                          elit. Quidem neque maxime quam explicabo eaque
                          sapiente molestias ducimus excepturi, facilis sunt
                          dolore doloremque similique veniam quas et itaque.
                          Consequatur blanditiis quisquam placeat facilis?
                        </Row>
                      </Col>
                    </Row>
                    <Row>
                      ...
                      <Col>
                        ...
                        <Row className="user-profile-content">
                          Lorem, ipsum dolor sit amet consectetur adipisicing
                          elit. Tenetur aspernatur esse repellendus, sapiente
                          quod praesentium voluptas labore maiores modi libero,
                          debitis molestias dicta a similique quia, et officiis
                          quam itaque. Veniam, sit.
                        </Row>
                      </Col>
                    </Row>
                  </Col>
                </Route>
                <Route path="/dashboard/companies/details/applicant-details/project-portfolio">
                  <Col>
                    <Row>
                      <Col>
                ...
                <Route path="/dashboard/companies/details/applicant-details/education">
                  <Row
                    style={{
                      display: "flex",
                      flexDirection: "column",
                ...
                <Route path="/dashboard/companies/details/applicant-details/contact">
                  <Col>
