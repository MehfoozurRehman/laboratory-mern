      ...
      <Col style={{ flex: "1" }}>
        <Row>
          ...
          >
            <Nav.Link
              as={Link}
              to="/dashboard/jobseeker/personal"
              className="user__profile__messanger"
            >
        ...
        <Row style={{ padding: "1em 0em" }}>
          <Nav variant="pills" defaultActiveKey="/dashboard/jobseeker/details">
            <Nav.Link
              to="/dashboard/jobseeker/details"
              href="/dashboard/jobseeker/details"
              as={Link}
            ...
            <Nav.Link
              to="/dashboard/jobseeker/details/applied"
              as={Link}
              className="nav__link__horizontal"
              eventKey="link-1"
            >
            ...
            <Nav.Link
              to="/dashboard/jobseeker/details/work-Experience"
              as={Link}
              className="nav__link__horizontal"
              eventKey="link-2"
            >
            ...
            <Nav.Link
              to="/dashboard/jobseeker/details/project-portfolio"
              as={Link}
              className="nav__link__horizontal"
              eventKey="link-3"
            >
            ...
            <Nav.Link
              to="/dashboard/jobseeker/details/education"
              as={Link}
              className="nav__link__horizontal"
              eventKey="link-4"
            >
            ...
            <Nav.Link
              to="/dashboard/jobseeker/details/contact"
              as={Link}
              className="nav__link__horizontal"
              eventKey="link-5"
            >
        ...
        <Row>
          <Switch>
            <Route path="/dashboard/jobseeker/details" exact>
              <Col>
                <Row>
                  <Col>
                    <Row>
            ...
            <Route path="/dashboard/jobseeker/details/applied">
            ...
            <Route path="/dashboard/jobseeker/details/work-Experience">
            ...
            <Route path="/dashboard/jobseeker/details/project-portfolio">
              <Col>
                <Row>
                  <Col>
            ...
            <Route path="/dashboard/jobseeker/details/education">
              <Row
                style={{
                  display: "flex",
                  flexDirection: "column",
            ...
            <Route path="/dashboard/jobseeker/details/contact">
              <Col>
